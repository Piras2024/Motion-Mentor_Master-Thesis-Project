...
python exp/run_demo.py --input_path "data_inputs/demo/example_videos/squat/32903_8.mp4"
```
MULTIPLE VIDEOS FOLDER:

```shell
 python exp/run.py --input_path "data_inputs/demo/example_videos/squat"  --rec_bs 128 --max_instances 1 --device 'cuda:0'
```
...
- [x] Release Huggingface demo.pip cache purge
